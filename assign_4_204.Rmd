...
#theta function
theta_function_2d <- function(theta){pct_change_results[1]-
    ((sum(((((1-theta)*uncertain_2_df$total_econ_activity))^(1-n)/(1-n))/(1+r)^t))*.2 +
    (sum(((((1-theta)*uncertain_4_df$total_econ_activity))^(1-n)/(1-n))/(1+r)^t))*.5 +
    (sum(((((1-theta)*uncertain_6_df$total_econ_activity))^(1-n)/(1-n))/(1+r)^t))*.3)}
