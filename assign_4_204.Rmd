...
# part_c_df_44 <- temp44_cc_df %>% 
#   select(cons_PV) %>% 
#   rename("cons_PV44" = cons_PV)
# 
# part_c_df_0 <- zero_cc_df %>% 
#   select(cons_PV) %>% 
#   rename("cons_PV0" = cons_PV)

part_c_df_full <- data.frame("year" = seq(0,200, by = 1), "zero_utility_PV" = zero_PV_df$zero_PV, "change_utility_PV" = temp44_PV_df$temp44_PV)

# No Climate Change 
# define function Temperature over time 
theta_zero_cc_run <- function(t, T){
